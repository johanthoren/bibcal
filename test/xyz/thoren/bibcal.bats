...
@test "invoking bibcal with argument -x -y -Y and -z plus arguments" {
    run ./bibcal -Y -x -74.006111 -y 40.712778 -z America/New_York 2021 9 11 9 0
    [ "$status" -eq 0 ]
    [[ "${lines[3]}" =~ "2021-09-11 09:00:00" ]]
    [[ "${lines[5]}" =~ "6" ]]
    [[ "${lines[6]}" =~ "4" ]]
